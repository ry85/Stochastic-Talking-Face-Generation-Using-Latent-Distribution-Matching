...
def normalize_audio(opt, dtype, sequence):
    sequence.transpose_(1, 0)  #[75, 10, 10000]

    return sequence_input(sequence, dtype)

def normalize_frame(opt, dtype, sequence):
    sequence.transpose_(3, 4).transpose_(2, 3).transpose_(1, 0)  #[75, 10, 3, 128, 128]
...
def save_tensors_image1(inputs, padding=0):
    images = image_tensor(inputs, padding)
